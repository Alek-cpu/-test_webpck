...
eval("var dragNDrop = function dragNDrop() {\n  var cardContainer = document.querySelector('.drag-drop-wrapper');\n  var cards = cardContainer.querySelectorAll('.drag-drop-wrapper > .card');\n  var statusEvent = document.querySelector('.drag-drop-wrapper');\n  var cells = statusEvent.querySelectorAll('.drag-drop-wrapper > .card > .event-wrap > .identical-inner > .status-event > .edit-control > .deleted');\n\n  function removeCard() {\n    var _loop = function _loop(i) {\n      var _loop2 = function _loop2(j) {\n        cells[i].addEventListener('click', function (e) {\n          if (i == j) {\n            cards[i].remove();\n          }\n        });\n      };\n\n      for (var j = 0; j < cells.length; j++) {\n        _loop2(j);\n      }\n    };\n\n    for (var i = 0; i < cards.length; i++) {\n      _loop(i);\n    }\n  }\n\n  removeCard();\n};\n\ndragNDrop(); // THIS_THIS\n\n//# sourceURL=webpack:///./src/js/drag&drop.js?");
